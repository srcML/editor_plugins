...
class srcMLTransformResult:
    ...
    def __len__(self) :
        """Return: The number of units in the transformation result  to get_unit_size"""
    ...
    def __getitem__(self, i: int) :
        """Return: The unit at index i  to get_unit"""
        if type(i) != int:
            raise srcMLTypeError(self.get_unit,"i",i)
        if self.get_type() != srcMLResult.UNITS:
            raise srcMLInvalidResultType()
