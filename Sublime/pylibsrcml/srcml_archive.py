...
class srcMLArchive:
    def __init__(self, arch_ptr: None  = None):
    ...
    def set_xml_encoding(self, encoding: str) :
        """
        Set the XML encoding of the srcML archive
        Parameter: encoding e
        Return: CHANGED FOR PYLIBSRCML: returns nothing, simply raises an error if status isn't OK
        """
    ...
    def set_src_encoding(self, encoding: str) :
        """
    ...
    def set_options(self, option: int) :
        """
    ...
    def enable_option(self, option: int) :
        """
    ...
    def disable_option(self, option: int) :
        """
    ...
    def set_tabstop(self, tabstop: int) :
        """
    ...
    def register_file_extension(self, extension: str, language:str) :
        """
    ...
    def add_attribute(self, uri: str, name: str, value: str) :
        """
        ...
        status = libsrcml.srcml_archive_add_attribute(self.c_archive, uri.encode(), name.encode(), value.encode())
        check_srcml_status(status)
    ...
    def get_attribute_size() :
        ...
        """
        return libsrcml.srcml_archive_get_attribute_size(self.c_archive)
    ...
    def get_attribute_prefix(pos: int) :
        ...
        result = libsrcml.srcml_archive_get_attribute_prefix(self.c_archive, pos)
        return result.decode() if result else None
    ...
    def get_attribute_name(pos: int) :
        ...
        result = libsrcml.srcml_archive_get_attribute_name(self.c_archive, pos)
        return result.decode() if result else None
    ...
    def get_attribute_value(pos: int) :
        ...
        result = libsrcml.srcml_archive_get_attribute_value(self.c_archive, pos)
        return result.decode() if result else None

    def set_processing_instruction(self, target: str, data: str) :
        """
    ...
    def get_namespace_prefix(self, pos: int) :
        """
        Parameter: pos n
        Return: The prefix for the given position, or NULL
        """
    ...
    def get_prefix_from_uri(self, namespace_uri: str) :
        """
        Parameter: namespace_uri I
    ...
    def get_namespace_uri(self, pos: int) :
        """
        Parameter: pos n
    ...
    def get_uri_from_prefix(self, prefix: str) :
        """
        Parameter: prefix x
    ...
    def check_extension(self, filename: str) :
        """
    ...
    def set_srcdiff_revision(self,revision_number: int) :
        """
...
class srcMLArchiveRead(srcMLArchive):
    def __init__(self, source: str, string_read_mode: ["source","filename",None] = None, *, clone_from: srcMLArchive  = None):
        """Create a new srcml archive (constructor)"""
    ...
    def append_transform_xpath(self, xpath_string: str) :
        """
    ...
    def append_transform_xpath_attribute(self, xpath_string: str, prefix: str, namespace_uri: str, attr_name: str, attr_value: str) :
        """
        Append the XPath expression to the list of transformations/queries.
        ...
        Parameter: attr_name e
        Parameter: attr_value e
        Return: CHANGED FOR PYLIBSRCML: returns nothing, simply raises an error if status isn't OK
        """
        if type(xpath_string) != str:
    ...
    def append_transform_xslt_filename(self, xslt_filename: str) :
        """
    ...
    def append_transform_xslt_memory(self, xslt_buffer: bytes ) :
        """
        Append an XSLT program from a buffer to the list of transformations/queries
        Note: Currently no way to specify parameters or context
        Parameter: xslt_buffer T
        Return: CHANGED FOR PYLIBSRCML: returns nothing, simply raises an error if status isn't OK
        """
    ...
    def append_transform_relaxng_filename(self, relaxng_filename: str) :
        """
        Append the RelaxNG schema from a filename path to the list of transformations/queries
        Parameter: relaxng_filename h
    ...
    def append_transform_relaxng_memory(self, relaxng_buffer: bytes ) :
        """
        Append the RelaxNG schema in the buffer to the list of transformations/queries
        Parameter: relaxng_buffer a
        Return: CHANGED FOR PYLIBSRCML: returns nothing, simply raises an error if status isn't OK
        """
    ...
    def append_transform_srcql(self, srcql_string: str) :
        """
    ...
    def append_transform_srcql_attribute(self, srcql_string: str, prefix: str, namespace_uri: str, attr_name: str, attr_value: str) :
        """
        Append the srcQL query to the list of transformations/queries.
        Instead of outputting the results in a separate unit tag, output the complete
        archive marking the XPath results with a user provided element.
    ...
    def append_transform_srcql_element(self, srcql_string: str, prefix: str, namespace_uri: str, element: str) :
        """
        Append the srcQL query to the list of transformations/queries.
        Instead of outputting the results in a separate unit tag, output the complete
        archive marking the XPath results with a user provided element.
    ...
    def append_transform_param(self, param_name: str, param_value: str) :
        """
        Append an XSLT parameter to the last transformation
        Parameter: param_name r
        Parameter: param_value r
        Return: CHANGED FOR PYLIBSRCML: returns nothing, simply raises an error if status isn't OK
        """
    ...
    def append_transform_stringparam(self, param_name: str, param_value: str) :
        """
    ...
    def unit_apply_transforms(self, unit: srcMLUnit) :
        """
        ...
        result = srcMLTransformResult()
        check_srcml_status(libsrcml.srcml_unit_apply_transforms(self.c_archive,unit.c_unit, pointer(result.c_res)))
        return result
...
class srcMLArchiveWrite(srcMLArchive):
    def __init__(self, out: str , clone_from: srcMLArchive  = None):
        if not isinstance(clone_from,srcMLArchive) and clone_from != None:
            raise srcMLTypeError(self.__init__, "clone_from", clone_from, inheritance_flag=True)
...
class srcMLArchiveWriteString(srcMLArchiveWrite):
    def __init__(self, clone_from: srcMLArchive  = None):
        if not isinstance(clone_from,srcMLArchive) and clone_from != None:
            raise srcMLTypeError(self.__init__, "clone_from", clone_from, inheritance_flag=True)
