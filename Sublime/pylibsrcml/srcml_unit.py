...
class srcMLUnit:
    ...
    def get_attribute_prefix(pos: int) -> str :
        """
    ...
    def get_attribute_name(pos: int) -> str :
        """
    ...
    def get_attribute_value(pos: int) -> str :
        """
    ...
    def get_prefix_from_uri(self, namespace_uri: str) -> str :
        """
    ...
    def get_uri_from_prefix(self, prefix: str) -> str :
        """
    ...
    def parse_memory(self, src_buffer: bytes ) -> None :
        """
